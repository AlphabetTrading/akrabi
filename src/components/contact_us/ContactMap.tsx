...
const ContactMap = (props: Props) => {
  ...
  return (
    <div className="w-full h-full min-h-[600px] flex justify-center relative bg-blue-200">
      <iframe
        ...
        height="600"
        className={clsx(
          "contact-map w-full h-full min-h-[600px]",
          isIframeLoaded ? "relative" : "absolute",
        )}
        style={{ border: 0, backgroundColor: "#ff0000" }}
        allowFullScreen
        loading="lazy"
      ...
      />
      {!isIframeLoaded && (
        <div className="flex relative animate-pulse flex-row items-center w-full h-full min-w-[800px] min-h-[600px] justify-center space-x-5">
